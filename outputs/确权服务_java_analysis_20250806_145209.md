...
## 🏢 项目概览
- **服务名称**: 确权服务
- **分析时间**: 2025-08-06T14:52:05.104312
- **项目路径**: /Users/renyu/Documents/create_project/一局对接链数优化V0/crcl-open
...
### 业务域分布
- **open**: 1617个文件，层次：interfaces, base, application, domain
- **crcl**: 3个文件，层次：
- **credit**: 94个文件，层次：interfaces, base, application, domain
- **limit**: 533个文件，层次：interfaces, base, application, domain
...
- **包名**: com.yljr.crcl
- **层级**: application
- **注解**: @SpringBootApplication, @EnableDiscoveryClient, @EnableVestaIdStarter, @MapperScan, @EnableFeignClients, @EnableMonitor, @EnableMonitor, @EnableFeignClients, @EnableDiscoveryClient, @SpringBootApplication, @EnableVestaIdStarter, @MapperScan
