...
## 🏢 项目概览
- **服务名称**: 确权开立服务
- **分析时间**: 2025-07-20T21:37:09.179285
- **项目路径**: /Users/renyu/Documents/create_project/链数中建一局_1753017893/crcl-open
...
### 业务域分布
- **open**: 1617个文件，层次：interfaces, domain, application, base
- **crcl**: 3个文件，层次：
- **credit**: 94个文件，层次：interfaces, domain, application, base
- **limit**: 533个文件，层次：interfaces, domain, application, base
...
- **包名**: com.yljr.crcl
- **层级**: application
- **注解**: @EnableVestaIdStarter, @EnableFeignClients, @EnableMonitor, @EnableDiscoveryClient, @MapperScan, @SpringBootApplication, @EnableMonitor, @EnableFeignClients, @EnableDiscoveryClient, @SpringBootApplication, @EnableVestaIdStarter, @MapperScan
