...
## 🏢 项目概览
- **服务名称**: 确权开立服务
- **分析时间**: 2025-07-21T19:37:12.868322
- **项目路径**: /Users/renyu/Documents/create_project/链数中建一局_1753097294/crcl-open
...
### 业务域分布
- **open**: 1617个文件，层次：domain, interfaces, application, base
- **crcl**: 3个文件，层次：
- **credit**: 94个文件，层次：domain, interfaces, application, base
- **limit**: 533个文件，层次：domain, interfaces, application, base
...
- **包名**: com.yljr.crcl
- **层级**: application
- **注解**: @EnableMonitor, @MapperScan, @EnableDiscoveryClient, @SpringBootApplication, @EnableVestaIdStarter, @EnableFeignClients, @EnableMonitor, @EnableFeignClients, @EnableDiscoveryClient, @SpringBootApplication, @EnableVestaIdStarter, @MapperScan
