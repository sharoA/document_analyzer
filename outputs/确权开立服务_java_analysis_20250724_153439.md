...
## 🏢 项目概览
- **服务名称**: 确权开立服务
- **分析时间**: 2025-07-24T15:34:34.653017
- **项目路径**: /Users/renyu/Documents/create_project/链数中建一局_1753342376/crcl-open
...
### 业务域分布
- **open**: 1617个文件，层次：application, base, domain, interfaces
- **crcl**: 3个文件，层次：
- **credit**: 94个文件，层次：application, base, domain, interfaces
- **limit**: 533个文件，层次：application, base, domain, interfaces
...
- **包名**: com.yljr.crcl
- **层级**: application
- **注解**: @SpringBootApplication, @EnableVestaIdStarter, @EnableDiscoveryClient, @MapperScan, @EnableFeignClients, @EnableMonitor, @EnableMonitor, @EnableFeignClients, @EnableDiscoveryClient, @SpringBootApplication, @EnableVestaIdStarter, @MapperScan
