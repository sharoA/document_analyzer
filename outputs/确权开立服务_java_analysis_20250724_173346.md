...
## 🏢 项目概览
- **服务名称**: 确权开立服务
- **分析时间**: 2025-07-24T17:33:41.400329
- **项目路径**: /Users/renyu/Documents/create_project/链数中建一局_1753349525/crcl-open
...
### 业务域分布
- **open**: 1617个文件，层次：domain, application, base, interfaces
- **crcl**: 3个文件，层次：
- **credit**: 94个文件，层次：domain, application, base, interfaces
- **limit**: 533个文件，层次：domain, application, base, interfaces
...
- **包名**: com.yljr.crcl.open
- **层级**: config
- **注解**: @RunWith, @SpringBootTest, @RunWith, @SpringBootTest
...
- **包名**: com.yljr.crcl
- **层级**: application
- **注解**: @EnableMonitor, @EnableDiscoveryClient, @MapperScan, @SpringBootApplication, @EnableFeignClients, @EnableVestaIdStarter, @EnableMonitor, @EnableFeignClients, @EnableDiscoveryClient, @SpringBootApplication, @EnableVestaIdStarter, @MapperScan
